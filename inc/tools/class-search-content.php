	...
	public function handle_tool_call( array $parameters, array $tool_def = array() ): array {
		...
		$data = array(
			...
			'next_step'    => array() === $items
				? 'No published Extra Chill articles matched this query. Say so plainly — do not fabricate coverage or a quote. Offer a different phrasing, or answer only from what you can genuinely ground.'
				: 'Answer from these published articles and cite them — the sources render as citation cards, and you can also link the titles inline. Ground every music/editorial claim (a quote, a fact, what Extra Chill said) in one of these results; do not assert anything they do not support.',
		);
